...
- **Component-level docs:** Components with `readme.md`: acm-configuration, cert-manager-configuration, nmstate-configuration, openshift-config, openshift-virtualization-instance, acm-observability, user-workload-monitoring, external-dns-configuration, trilio-instance, infinidat-appliance. All components should eventually have one.
